...
namespace WFBS.Negocio
{
    public class Usuario : ICrud
    {
        ...
        public bool ValidarUsuario()
        {
            try
            {
                DALC.WFBSEntities user = new DALC.WFBSEntities();
                DALC.USUARIO us = user.USUARIO.First(b => b.RUT == this.Rut && b.PASSWORD == this.Password && b.ID_PERFIL == 1);
        ...
        public bool Read()
        {
            ...
            {
                DALC.WFBSEntities user = new DALC.WFBSEntities();
                DALC.USUARIO us = user.USUARIO.First(b => b.RUT == this.Rut);
