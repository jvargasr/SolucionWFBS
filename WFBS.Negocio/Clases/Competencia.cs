...
namespace WFBS.Negocio
{
    public class Competencia : ICrud
    {
        ...
        public bool Create()
        {
            try
            {
                DALC.WFBSEntities compe = new DALC.WFBSEntities();
                DALC.COMPETENCIA com = new COMPETENCIA();
        ...
        public bool Read()
        {
            ...
            {
                DALC.WFBSEntities compe = new DALC.WFBSEntities();
                DALC.COMPETENCIA com = compe.COMPETENCIA.First(c => c.ID_COMPETENCIA == this.Id_competencia);
